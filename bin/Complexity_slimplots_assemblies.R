...
#############################################################
virus_species <- complexity_table$viral_species[!duplicated(complexity_table$viral_species)] # Make a vector containing unique taxids
...
#tabla_features$Viral_species must be equal to taxids
